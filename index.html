...
<body ontouchstart="">
	...
	<div align="center"><input type="button" class="button" id="toggle-language" value="it" onclick="toggleLang()" /></div>
	...
	<div id="footer" class="footer">&copy 2017-2019 Giuseppe Bertolini </div>
</body>
